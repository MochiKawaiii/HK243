...
class GomokuGame:
    def __init__(self, root, board_size=6, win_length=5):
        """
        Hàm khởi tạo, thiết lập các thành phần chính của game.
        """
        self.root = root
        self.board_size = board_size
        self.win_length = win_length # <-- THAM SỐ MỚI CHO LUẬT CHƠI
        self.root.title(f"Game XO {board_size}x{board_size} ({win_length}-in-a-row to win)")
...
if __name__ == "__main__":
    root = tk.Tk()
    # Khởi tạo game với bàn cờ 6x6 và luật thắng 5 ô
    game = GomokuGame(root, board_size=6, win_length=5)
    root.mainloop()
...
def checkWinner():
    ...
    # Các điều kiện thắng của người chơi 1 [X]
    ...
    # Các điều kiện thắng của người chơi 2 [O]
    elif button1["text"] == "O" and button2["text"] == "O" and button3["text"] == "O" and button4["text"] == "O":
        win = True
        ...
        messagebox.showinfo("OX Game", "Player 2 WINNER!!")
        disableButtons()
    elif button1["text"] == "O" and button5["text"] == "O" and button9["text"] == "O" and button13["text"] == "O":
        win = True
        messagebox.showinfo("OX Game", "Player 2 WINNER!!")
        disableButtons()
    elif button2["text"] == "O" and button6["text"] == "O" and button10["text"] == "O" and button14["text"] == "O":
        win = True
        messagebox.showinfo("OX Game", "Player 2 WINNER!!")
        disableButtons()
    elif button3["text"] == "O" and button7["text"] == "O" and button11["text"] == "O" and button15["text"] == "O":
        win = True
        messagebox.showinfo("OX Game", "Player 2 WINNER!!")
        disableButtons()
    elif button4["text"] == "O" and button8["text"] == "O" and button12["text"] == "O" and button16["text"] == "O":
        win = True
        messagebox.showinfo("OX Game", "Player 2 WINNER!!")
        disableButtons()
